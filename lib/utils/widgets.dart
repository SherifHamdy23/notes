...
class PriorityPicker extends StatefulWidget {
  ...
  const PriorityPicker({super.key, required this.onTap, required this.selectedIndex});
  @override
...
class ColorPicker extends StatefulWidget {
  final Function(int) onTap;
  final int selectedIndex;
  const ColorPicker({super.key, required this.onTap, required this.selectedIndex});
  @override
